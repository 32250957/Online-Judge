...
POSTGRES_INDEX_MIGRATIONS = [
    ...
    "CREATE INDEX IF NOT EXISTS ix_judge_jobs_status_priority_id ON judge_jobs (status, priority DESC, id)",
    ...
    "CREATE INDEX IF NOT EXISTS ix_algorithm_tags_active_order ON algorithm_tags (is_active, order_index, id)",
    "CREATE INDEX IF NOT EXISTS ix_problems_judge_priority ON problems (judge_priority, id)",
...
POSTGRES_COLUMN_MIGRATIONS = [
    ...
    "ALTER TABLE problems ADD COLUMN IF NOT EXISTS python_time_limit INTEGER",
    "ALTER TABLE problems ADD COLUMN IF NOT EXISTS c_time_limit INTEGER",
    "ALTER TABLE problems ADD COLUMN IF NOT EXISTS cpp_time_limit INTEGER",
    "ALTER TABLE problems ADD COLUMN IF NOT EXISTS java_time_limit INTEGER",
    "ALTER TABLE problems ADD COLUMN IF NOT EXISTS difficulty VARCHAR(50) NOT NULL DEFAULT '미지정'",
    "ALTER TABLE problems ADD COLUMN IF NOT EXISTS tier INTEGER NOT NULL DEFAULT 0",
    ...
    "ALTER TABLE contests ADD COLUMN IF NOT EXISTS scoreboard_freeze_enabled BOOLEAN NOT NULL DEFAULT FALSE",
    "ALTER TABLE contests ADD COLUMN IF NOT EXISTS scoreboard_freeze_minutes INTEGER NOT NULL DEFAULT 0",
    ...
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS profile_image_url VARCHAR(500) NOT NULL DEFAULT ''",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS selected_profile_badge_id INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS selected_profile_background_id INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS profile_message TEXT NOT NULL DEFAULT ''",
    ...
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS ac_rating INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS ac_tier INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS ac_rating_problem_sum INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS ac_rating_solved_bonus INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE users ADD COLUMN IF NOT EXISTS solved_count INTEGER NOT NULL DEFAULT 0",
    "ALTER TABLE profile_assets ADD COLUMN IF NOT EXISTS condition_value VARCHAR(120) NOT NULL DEFAULT ''",
    "ALTER TABLE profile_assets ADD COLUMN IF NOT EXISTS is_default BOOLEAN NOT NULL DEFAULT FALSE",
    ...
    "ALTER TABLE problems ADD COLUMN IF NOT EXISTS judge_priority INTEGER NOT NULL DEFAULT 0",
...
KNOWN_TABLE_COLUMNS = {
    "contests": {"id", "display_number", "title", "description", "start_time", "end_time", "is_public", "is_ended", "is_exam_mode", "hide_ranking", "result_display_mode", "score_enabled", "scoreboard_freeze_enabled", "scoreboard_freeze_minutes", "created_at"},
    ...
    "users": {"id", "username", "password_hash", "is_admin", "submit_banned_until", "ban_reason", "profile_background_url", "profile_image_url", "selected_profile_badge_id", "selected_profile_background_id", "profile_message", "full_name", "student_id", "must_change_password", "is_deleted", "deleted_at", "created_at", "ac_rating", "ac_tier", "ac_rating_problem_sum", "ac_rating_solved_bonus", "solved_count"},
    ...
    "problems": {"id", "title", "description", "input_description", "output_description", "time_limit", "memory_limit", "python_time_limit", "c_time_limit", "cpp_time_limit", "java_time_limit", "is_contest_only", "is_public", "force_private_submission", "is_judge_ready", "difficulty", "tier", "judge_priority", "tags", "source", "problem_author", "error_finder", "typo_finder", "allowed_languages", "origin_type", "origin_group_id", "origin_contest_id", "review_status", "display_code"},
    "algorithm_tags": {"id", "key", "name", "description", "is_active", "order_index", "created_at"},
    ...
    "profile_assets": {"id", "asset_type", "title", "description", "image_url", "icon_text", "condition_type", "condition_problem_ids", "condition_value", "is_default", "is_active", "created_at"},
}

SERIAL_TABLES = [
    "users", "algorithm_tags", "problems", "contests", "problem_examples", "problem_notes", "problem_hints", "submissions", "contest_questions", "contest_editorials",
    "groups", "messages", "group_join_requests", "group_problem_sets", "group_contests",
    "group_practices", "group_problem_set_problems", "group_practice_problems", "judge_jobs", "judge_logs", "audit_logs", "board_posts", "board_comments", "profile_assets",
]
